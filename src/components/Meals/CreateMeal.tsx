                ...
                <ModalBody>
                    <Form onSubmit={this.createMeal}>
                        <FormGroup>
                            ...
                            <Input className="inputSpacer" name="thoughts" type="textarea" rows="5" value={this.state.thoughts} placeholder="Use this area to journal your thoughts about this meal." onChange={(e) => this.setState({thoughts: (e.target.value)})}/>
